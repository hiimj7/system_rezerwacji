...
<html lang="en">
<head>
    <title>System zarządzania egzaminami na Politechnice Lubelskiej</title>
...
<nav class="navbar navbar-inverse">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/home') }}">eDyplom</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li><a href="{{url('event')}}">Kalendarz</a></li>
                <li><a href="{{url('event-list')}}">Lista rezerwacji</a></li>
