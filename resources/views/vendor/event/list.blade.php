        ...
        <div class="modal-dialog" >
            <div class="modal-content admin-form">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Pokaż egzamin</h4>
                </div>
                        ...
                        <div class="row">
                            <div class="pull-left" style="width: 75%;">
                                <div class="col-lg-5 col-xs-12">
                                    <div class="form-group">
                                        <input type="text"   name="event_start_date" required="" id="event_start_date" value="" class="form-control date_pick" placeholder="Data początku">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-5 col-xs-12" id="event_start_time_area" style="display: none">
                                    <!--                                 none-->
                                    <div class="form-group">
                                        <input type="text"   name="event_start_time" id="event_start_time" value="24:00" class="form-control time_pick" placeholder="Czas początku">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pull-left" style="width: 75%;">
                                ...
                                <div class="col-lg-2 col-xs-2">
                                    <div id="end_time_toggle">
                                        <button type="button"  class="btn btn-md"  title="Dodaj czas końca"  onclick="add_end_time()">
                                            <i class="text-success fa fa-plus"></i>
                                            <i class="text-success fa fa-clock"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="col-lg-5 col-xs-12" id="event_end_time_area" style="display: none">
                                    <!--                    //none-->
                                    <input type="text"   name="event_end_time" id="event_end_time" value="23:59" class="form-control time_pick" placeholder="Czas końca">
                                </div>
                            </div>
                            <div class="pull-right">
                                <div class="col-lg-2 col-xs-2">
    ...
    <div class="modal fade" id="edit_event_modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" >
            <div class="modal-content admin-form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Edytuj egzamin</h4>
                </div>
                <div class="modal-body">
                    ...
                    <form id="edit_event_frm" action=""  method="post" enctype="multipart/form-data"  >
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="form-group">
                                    <label class="">Tytuł egzaminu</label>
                                    <input type="text" name="event_title" id="edit_event_title" required=""  class="form-control" placeholder="Tytuł egzaminu">
                                </div>
                        ...
                        <div class="row">
                            <div class="pull-left" style="width: 75%;">
                                <div class="col-lg-5 col-xs-12">
                                    <div class="form-group">
                                        <label class="">Data początku</label>
                                        <input type="text"   name="event_start_date" required="" id="edit_event_start_date" value="" class="form-control date_pick" placeholder="Data początku">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xs-2">
                                    <div id="edit_start_time_toggle" class="mt30">
                                        <button type="button"  class="btn btn-md" title="Usuń czas"   onclick="edit_remove_start_time()">
                                ...
                                <div class="col-lg-5 col-xs-12" id="edit_event_start_time_area" style="display: block">
                                    <div class="form-group">
                                        <label class="">Czas początku</label>
                                        <input type="text"   name="event_start_time" id="edit_event_start_time" value="" class="form-control time_pick" placeholder="Czas początku">
                                    </div>
                                </div>
                            </div>
                            <div class="pull-right" >
                            ...
                            <div class="pull-left" style="width: 75%;">
                                ...
                                <div class="col-lg-2 col-xs-2">
                                    <div id="edit_end_time_toggle" class="mt30">
                                        <button type="button"  class="btn btn-md" title="Usuń czas"   onclick="edit_remove_end_time()">
                                            <i class="text-danger fa fa-times"></i>
                                            <i class="text-danger fa fa-clock"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="col-lg-5 col-xs-12" id="edit_event_end_time_area" style="display: block">
                                    <div class="form-group">
                                        <label class="">Czas końca</label>
                                        <input type="text"   name="event_end_time" id="edit_event_end_time" value="" class="form-control time_pick" placeholder="Czas końca">
                                    </div>
                                </div>
                            </div>
                            <div class="pull-right">
...
@section('content_script')
    <script>
        ...
        function view_event(event_id){
            ...
            $.get(single_event_url, function (r) {
                ...
                if(edata.id>0){
                    ...
                    $('#view_faculty').text(edata.faculty)
                    $('#view_classroom').text(edata.classroom);
        ...
        function date_compare(){
            ...
            if($('#set_end_date_data').val()=="Yes"){
                ...
                if(start_time>end_time){
                    $('#create_event_alert').show().html('<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>Czas końcowy musi być większy niż czas początkowy!</div>');
                    return false;
                    //   return false;
        ...
        function edit_remove_start_time(){
            ...
            $('#edit_event_start_time').val('24:00');
